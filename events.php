...
<?php
	...
	$query = "SELECT first_name, new_last_name, email, event, invite, event_time, event_date, address1, address2, description, post_date FROM events NATURAL JOIN spotsyUsers ORDER BY post_date DESC";
